...
{
	c.SwaggerDoc("v1", new OpenApiInfo { Title = "BE_QuanLyBanVeXemPhim_API", Version = "v1" });
...
builder.Services.AddDbContext<DbNhapMonContext>(options =>
{
...
app.UseSwaggerUI(c =>
{
	c.SwaggerEndpoint("/swagger/v1/swagger.json", "BE_QuanLyBanVeXemPhim_API V1");
});
